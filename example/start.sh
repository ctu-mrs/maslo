...
PROJECT_NAME=maslo_example
SESSION_NAME=maslo_example
...
'
# play the whole bag
  'rosbag_play' './waitForRos.sh; rosbag play $(rospack find mas_datasets)/bag_files/processed/rectangle_proc.bag --clock -r 1.0
'
# run the MAS-LO algorithm
  'maslo' './waitForRos.sh; roslaunch maslo.launch 
'
# run rviz
